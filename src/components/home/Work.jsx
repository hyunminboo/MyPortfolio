        ...
        {works.map((work, idx) => (
          <li key={work.id}>
            <a href={work.links.notion} className='lst-t-wrap'>
              <span className="work-num">{String(idx + 1).padStart(2, '0')}</span>
              ...
              <div className="work-links">
                <a href={work.links.notion} onClick={e => e.stopPropagation()}>Notion ↗</a>
                <a href={work.links.demo} onClick={e => e.stopPropagation()}>Live Demo ↗</a>
              </div>
            </a>
            <a href={work.links.demo} className="lst-img-wrap">
              <div className="bg" style={{ backgroundImage: `url(${work.thumbnail})` }}></div>
            </a>
          </li>
        ))}
      </ul>
